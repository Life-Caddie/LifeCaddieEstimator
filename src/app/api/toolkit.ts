...
1. X-Minute In-Home Assessment - On-site evaluation of the home, safety concerns, organizational challenges, and support needs to determine scope and next steps. Replace 'X' with a number up to 90 minutes based on magnitude of work.
2. X-Minute Virtual Assessment - Remote consultation to assess goals, overwhelm levels, and organizational needs when in-home assessment is not required. Replace 'X' with a number up to 60 minutes based on magnitude of work.
...
8. X-Day Action Plan - A short-term, realistic plan that breaks priorities into manageable weekly actions. Replace 'X' with a number up to 30 days, based on magnitude of work.
